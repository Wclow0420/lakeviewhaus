...
export default function OrderDetailScreen() {
  ...
  // Real-time: server pushes order_update on every state transition.
  useEffect(() => {
    if (!orderId) return;
      ...
      <View style={[styles.container, { backgroundColor: theme.background, paddingTop: insets.top }]}>
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.back()}
          >
            <Text style={[styles.primaryButtonText, { color: theme.secondary }]}>Go Back</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + 16, backgroundColor: theme.card }]}>
        {isPending || isFailed ? (
          ...
          <TouchableOpacity
            ...
            onPress={() => router.back()}
          >
            <Text style={[styles.primaryButtonText, { color: theme.secondary }]}>Back to Orders</Text>
          </TouchableOpacity>
        )}
      </View>
    </View>
